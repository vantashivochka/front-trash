        ...
        <div className="flex justify-center flex-col items-center gap-6 mt-10 md:pt-16 pb-6 max-w-4xl w-full mx-auto">
          <div className="flex flex-col gap-6">
            <div className="flex flex-col gap-1.5 text-center">
              <h2 className="text-sm md:text-lg text-primary font-bold">
                По завжди актуальним цінам<br />
                Першим клієнтам - знижка 10%
              </h2>
              <h1 className="text-3xl md:text-4xl font-bold tracking-tight bg-accent-foreground px-1.5 py-1 rounded-md text-muted">
